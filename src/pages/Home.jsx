  ...
  return (
    <div>
      ...
      <div>
          <div className="hero my-20 ">
            <div className="hero-content flex-col lg:flex-row-reverse">
              <img
                ...
                className="lg:max-w-lg rounded-lg shadow-xl lg:ml-20"
              />
        ...
        <div>
          <h1 className="text-4xl lg:text-5xl font-bold my-20 text-center">Services</h1>
        </div>
          ...
          <div className="hero my-20">
            <div className="hero-content flex-col lg:flex-row">
              <img
                ...
                className="lg:max-w-lg rounded-lg shadow-xl lg:mr-20"
              />
              <div className=" mx-auto">
                <h1 className="text-4xl lg:text-5xl font-bold">Clients Review!</h1>
                <p className="py-6 lg:text-lg">
